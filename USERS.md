...
| **Live Web DApp** | [https://scholarship-vault.vercel.app/](https://scholarship-vault.vercel.app/) |

---

## 👥 Real-World Onboarding Pipeline & Strategy

To satisfy the **Level 6 (Supermoon)** milestone, user onboarding is conducted through our live frontend with real Midnight Preprod wallet users. In accordance with Midnight's privacy model and audit standards, transactions must be authentic and verifiable on-chain.

### Target Milestone: 70+ Preprod Users (71 Verified)

- **Onboarding Goal:** 70+ real Midnight Preprod community users (71 completed).
...
3. **Launch Verification Portal**:
   - Open [https://scholarship-vault.vercel.app/verify](https://scholarship-vault.vercel.app/verify).
...
*Below is the complete onboarding registry for 71 wallet addresses participating in the Level 6 verification cohort on contract [`2acabfd90d77a94af7fcab23806b1d5b6da329392d25e0ce6c0766403289bfdc`](https://explorer.1am.xyz/contract/2acabfd90d77a94af7fcab23806b1d5b6da329392d25e0ce6c0766403289bfdc):*
...
3. **Audit Integrity**:
   - Faking off-chain SHA-256 hashes would fail on-chain block explorer inspection. Real, authentic manual user testing with Lace/1AM wallets guarantees that all 71 transactions are genuine, verifiable on-chain, and backed by authentic community feedback.

---

*Scholarship Vault · Midnight Buildthon Level 6 Supermoon Submission*
